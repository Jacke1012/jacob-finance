...
<body>
    ...
    <div class="container">
        ...
        <div class="div-primary">
            <form id="expense-form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" id="amount-txt" required>
                </div>
                <div class="form-group">
                    <label for="description">Company:</label>
                    <input type="text" class="form-control" id="company-txt" autocomplete="on">
                </div>
                <div class="form-group">
                    <label for="description">Description:</label>
                    <input type="text" class="form-control" id="description-txt" autocomplete="on">
                </div>
        ...
        <div class="div-primary" id="month-select">
            <h2>Expenses</h2>
